...
class VideoMiniGPT4(Blip2Base):
    ...
    def __init__(
        ...
        print('Loading LLAMA')
        #self.llama_tokenizer =  LlamaTokenizer.from_pretrained(llama_model,  device_map="auto", load_in_8bit=True,low_cpu_mem_usage=True, local_files_only=True, cache_dir="/mnt/e/project", max_shard_size="50MB",safe_serialization=True)
    ...
    def vit_to_cpu(self):
        self.ln_vision.to("gpu")
        self.ln_vision.float()
        self.visual_encoder.to("gpu")
    ...
    def from_config(cls, cfg):
        ...
        if ckpt_path:
            ...
            ckpt = torch.load(ckpt_path, map_location="gpu")
